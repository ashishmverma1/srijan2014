  ...
  $.simpleWeather({
    ...
    success: function(weather) {
	  ...
	  setInterval(function() {
		  ...
		  var mm = start.getMinutes();
		  var time;
		  var tt;
		  if(hh > 12){ tt='PM';		hh -= 12; }
		  else if(hh == 12){ tt='PM'; }
		  else if(hh == 0){ tt='AM'; hh = 12; }
		  else if(hh < 12){ tt='AM'; }
		  if(mm < 10) time = hh + ':' + '0' + mm + ' ' + tt;
	  	  else time = hh + ':' + mm + ' ' + tt;
		  $('.currently').text(time);
	  }, 1000);
